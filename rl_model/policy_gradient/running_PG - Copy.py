...
for i in range (iterations):
    ...
    sim.add_simulation_component(parser)
    #sim.add_tickable(parser)
    #sim.add_postrun(parser.post_run) 
    sim.run(sumocfg1, gui=True,time_steps = 2000)
...
save_dataframe2CSV(simulation_dataFrame,"D:\\My study\\5th year\\Graduation Project\\traffic-optimization\\rl_model\\policy_gradient\\pg_results_alpha05.csv")
